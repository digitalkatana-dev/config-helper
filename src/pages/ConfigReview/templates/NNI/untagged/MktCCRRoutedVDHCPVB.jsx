...
const MktCCRRoutedVDHCPVB = () => {
	...
	return (
		<div className='template'>
			<h2>Mikrotik - 5009 CCR Routed - with Voice DHCP Server Voice Bridge</h2>
			<pre>
...
add action=dst-nat chain=dstnat dst-port=2222 in-interface=sfp-sfpplus1 log=yes port="" protocol=tcp to-addresses=192.168.25.2 to-ports=22
