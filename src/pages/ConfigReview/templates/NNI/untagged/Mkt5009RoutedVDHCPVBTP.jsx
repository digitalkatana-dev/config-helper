...
/ip address													
add address=[[[[[CHANGE WAN IP ADDRESS][/NOTATION for SUBNET ex:192.168.1.2/30]]]]]]]] interface=ether1 network=[[[[[WAN NETWORK IP ADDRESS]]]]]]]
...
add action=dst-nat chain=dstnat dst-port=8080 in-interface=ether1 log=yes \
...
/snmp
set contact=support@nextlevelinternet.com enabled=yes location="[[[[[CLIENT ADDRESS]]]]]]]" trap-generators=interfaces trap-interfaces=ether1 trap-target=207.7.100.77 trap-version=2
/system clock
