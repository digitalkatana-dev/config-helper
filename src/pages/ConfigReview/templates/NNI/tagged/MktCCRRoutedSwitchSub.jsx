...
/ip address
add address=[[[[[CHANGE WAN IP ADDRESS][/NOTATION for SUBNET ex:192.168.1.2/30]]]]] interface=[[[[[reference sfpplus1 name above]]]]] network=[[[[WAN NETWORK IP ADDRESS]]]]
add address=192.168.25.1/24 interface=sfp-sfpplus3 network=192.168.25.0
add address=[[[[[CHANGE LAN IP ADDRESS][/NOTATION for SUBNET ex:10.10.50.2/29]]]]] interface=sfp-sfpplus2 network=[[[[[LAN NETWORK IP ADDRESS]]]]]
...
add action=dst-nat chain=dstnat dst-port=2222 in-interface=[[[[[reference sfp-sfpplus1 name above Ex:ATT_ASE_5M]]]] log=yes port="" protocol=tcp to-addresses=192.168.25.2 to-ports=22
